  ...
  <section class="bg-body-secondary p-5" id="aboutSection">
    ...
    <div class="d-flex justify-content-center flex-wrap gap-4 mt-4">
      <div class="card border-info mb-3" style="max-width: 18rem;">
        <div class="card-header">DUO GEN</div>
        <div class="card-body">
          <h5 class="card-title">11 RPL 1 At SMKN 10 Surabaya</h5>
        </div>
      </div>
    </div>
  </section>
  ...
  <footer id="footer" class="p-3 bg-dark">
    ...
    <div class="row p-3">
      <div class="col mt-3">
        ...
        <p class="text-secondary fs-6">Jl. Keputih Tegal No.54, Keputih, Kec. Sukolilo, Surabaya, Jawa Timur 60111</p>
      </div>
      ...
      <div class="d-flex justify-content-center align-items-center mt-3">
        <p class="text-light">Made with <a href="" class="text-decoration-none">BagLal</a> 2024</p>
      </div>
    </div>
  </footer>
