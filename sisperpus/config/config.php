...
// Hapus semua data pengembalian terkait member
function deletePengembalianByNISN($nisn) {
  global $connection;
  $queryDeletePengembalian = "DELETE FROM pengembalian WHERE nisn = '$nisn'";
...
function deleteMember($nisnMember) {
  ...
  // Hapus semua data pengembalian yang terkait dengan member tersebut
  deletePengembalianByNISN($nisnMember);
